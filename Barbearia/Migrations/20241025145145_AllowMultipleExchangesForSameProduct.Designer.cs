...
namespace Barbearia.Migrations
{
    ...
    [Migration("20241025145145_AllowMultipleExchangesForSameProduct")]
    partial class AllowMultipleExchangesForSameProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Barbearia.Models.CategoryModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Barbearia.Models.ProductModel", b =>
                {
                    b.HasOne("Barbearia.Models.CategoryModel", "Category")
                        .WithMany("Products")
